				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="copyright__inner">
						<div class="cpy__right--left">
							<p>@All Right Reserved. <a href="https://freethemescloud.com/"> Pizza and Sandwich</a></p>
						</div>
						<div class="cpy__right--right">
							<a href="#">
								<img src="<?php echo base_url('assets/user/images/icon/shape/2.png'); ?>" alt="payment images">
							</a>
						</div>
					</div>
				</div>
			...
			<div class="cartbox__total">
				<ul>
					...
					<li class="shipping-charge">
						<span class="cartbox__total__title">Shipping Charge</span><span class="price">$05</span></li>
...
<!-- JS Files -->
<script src="<?php echo base_url('assets/user/js/vendor/jquery-3.2.1.min.js'); ?>"></script>
